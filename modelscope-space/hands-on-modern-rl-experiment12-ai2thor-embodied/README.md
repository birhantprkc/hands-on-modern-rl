---
title: AI2-THOR xGPU Embodied Home
emoji: 🧪
colorFrom: indigo
colorTo: purple
sdk: gradio
...
# WalkingLab × Hands-On Modern RL · AI2-THOR xGPU Embodied Home

**WalkingLab** 与开源课程 **Hands-On Modern RL（《动手学现代强化学习》）** 的实验 12。它在 AI2-THOR 的真实可交互房间中训练视觉 ObjectNav PPO，并从学习后的策略生成第一人称 GIF 回放。

...
这一节我们回顾了传统强化学习在长程任务上的主要探索方向：分层 RL、HER、基于模型规划（MBPO、Dreamer）、探索方法、奖励塑形、课程学习和模仿学习。这些方法的核心目标都是提升样本效率或解决稀疏奖励问题。
...
下一章：[9. Off-Policy 与 Model-Based RL](../chapter11_continuous_control/ddpg)

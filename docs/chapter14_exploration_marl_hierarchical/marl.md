...
上一节 [12.1](./intro) 我们解决了稀疏奖励下怎么让单个智能体自己"好奇探索"的问题。现在我们把问题再推进一步：如果环境里不止一个智能体呢？
...
2. **继承了 DDPG 的稳定性问题**：回忆 [第 9 章](../chapter11_continuous_control/intro#_12-3-td3-ddpg-的稳定性补丁) 讲过的 DDPG 的问题——过估计、超参数敏感、训练容易崩溃——这些问题在多智能体设定下会被进一步放大

...
## 6.6.1 Where the Value Baseline Comes From
...
## 6.6.2 Why CartPole Is Better for Seeing the Effect of a Value Baseline
...
## 6.6.3 Running the Comparison Experiment
...
## 6.6.4 Reading the Reward Curves
...
## 6.6.6 Reading the Variance Curves
...
## 6.6.7 What Actually Changed in the Code?
...
## 6.6.8 Returning to the Picture
